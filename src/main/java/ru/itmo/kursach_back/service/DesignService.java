...
public class DesignService {
    ...
    public DesignResponseDto generateDesign(GenerateDesignRequestDto request) {
        ...
        Integer ownerId = currentUser != null ? currentUser.getUserId() : null;
        ...
        // Anonymous generated designs are public by default
        design.setIsPublic(ownerId == null);
    ...
    /**
     * Get active generation themes for public access
     */
    public List<Map<String, Object>> getActiveThemes() {
        List<GenerationTheme> themes = themeRepository.findByIsActiveTrue();
        return themes.stream().map(theme -> {
            ...
            themeMap.put("promptTemplate", theme.getThemePromptTemplate());
            themeMap.put("previewImageId", theme.getPreviewImageId());
            return themeMap;
